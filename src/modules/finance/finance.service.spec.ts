...
describe('FinanceService', () => {
  ...
  describe('getMonthlyExpensesSummary', () => {
    it('should calculate summary correctly', async () => {
      const expenses = [
        { amount: 100, status: 'PENDING', category: 'Travel', expense_date: '2024-01-05' },
        { amount: 200, status: 'APPROVED', category: 'Food', expense_date: '2024-01-10' },
        { amount: 300, status: 'PAID', category: 'Travel', expense_date: '2024-01-15' },
      ];
  ...
  describe('updateExpense', () => {
    ...
    it('should throw NotFoundException if expense does not exist', async () => {
        ...
        await expect(service.updateExpense(id, { amount: 100 })).rejects.toThrow(NotFoundException);
    });
  });
